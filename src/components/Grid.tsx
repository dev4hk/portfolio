                ...
                <div className={"flex justify-end gap-3"}>
                    {project.demo != undefined &&
                        ...
                        <button
                            ...
                            <span
                                className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-3xl bg-slate-950 px-8 py-2 text-sm font-medium text-white backdrop-blur-3xl">
    Demo
  </span>
                        </button>
                    }
                    ...
                    >
                        ...
                        <div
                            className="px-8 py-2  bg-black rounded-3xl  relative group transition duration-200 text-white hover:bg-transparent">
                            Details
                        </div>
                    </a>
                </div>
